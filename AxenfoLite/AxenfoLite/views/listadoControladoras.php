    ...
    <div class="content-wrapper">
        ...
        <div class="col-md-12">
            ...
            <div class="box-header with-border">
                ...
                <a id="btngrupos" href="crearNodo.php"><button class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> Agregar Nodo</button></a> 
                <a id="btngrupos" href="crearIncidencia.php"><button class="btn btn-danger"><i class='glyphicon glyphicon-plus'></i> Agregar incidencia</button></a>
                </div> 
